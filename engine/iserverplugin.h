...
#define INTERFACEVERSION_ISERVERPLUGINCALLBACKS				"IGMODSERVERPLUGINCALLBACKS004" // NOTE: We renamed it to IGMODSERVERPLUGINCALLBACKS to not cause confusion with newer ISERVERPLUGINCALLBACKS versions.
...
public:
	...
	// added with holylib's version of the interface.
