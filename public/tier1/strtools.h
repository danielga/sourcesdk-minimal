...
#define V_UTF8CharsToWString Q_UTF8CharsToWString
#define V_UTF32ToWString Q_UTF32ToWString
#define V_WStringToUTF8 Q_WStringToUTF8
#define V_WStringCharsToUTF8 Q_WStringCharsToUTF8
#define V_WStringToUTF32 Q_WStringToUTF32

// Source2 Unicode Case Conversion
enum
{
