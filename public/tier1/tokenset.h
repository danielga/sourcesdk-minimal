...
template <class _T>
inline const char *tokenset_t< _T >::GetNameByToken( _T nameToken ) const
{
...
template <class _T>
inline const char *tokenset_t< _T >::GetNameByToken( _T nameToken, char const *szMismatchResult ) const
{
	const tokenset_t< _T > *c;
